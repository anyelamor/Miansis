		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax2"></div>
			 ...
			 <label for="mod_identidad" class="col-sm-3 control-label">Identidad</label>
			 <div class="col-sm-8">
				 <input type="text" class="form-control" id="mod_identidad" name="mod_identidad"  required>
			 ...
			 <div class="col-sm-8">
			   ...
			   <div class="form-group">
				<label for="mod_foto" class="col-sm-3 control-label">Foto</label>
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="mod_foto" name="mod_foto">
				</div>
			  </div>
